...
def construct_box(inst_root, inst_name, cls_name, dst):
    ...
    for inst, cls in zip(*(inst_list, cls_list)):
        ...
        for iid in inst_ids: 
            ...
            inst_info['objects'][str(iid)] = {'bbox': [int(xmin), int(ymin), \
                int(xmax), int(ymax)], 'cls':int(cls_label)}
...
if __name__ == '__main__':
    ...
    # train_image
    copy_file('/datasets01/cityscapes/112817/leftImg8bit/train',\
            '*_leftImg8bit.png', train_img_dst)
    # train_label
    copy_file('/datasets01/cityscapes/112817/gtFine/train',\
            '*_labelIds.png', train_label_dst)
    # train_inst
    copy_file('/datasets01/cityscapes/112817/gtFine/train',\
            '*_instanceIds.png', train_inst_dst)
    # val_image
    copy_file('/datasets01/cityscapes/112817/leftImg8bit/val',\
            '*_leftImg8bit.png', val_img_dst)
    # val_label
    copy_file('/datasets01/cityscapes/112817/gtFine/val',\
            '*_labelIds.png', val_label_dst)
    # val_inst
    copy_file('/datasets01/cityscapes/112817/gtFine/val',\
            '*_instanceIds.png', val_inst_dst)
    ...
    if not os.path.exists(val_bbox_dst):
        os.makedirs(val_bbox_dst)
    # wrote a bounding box summary 
    construct_box('/datasets01/cityscapes/112817/gtFine/train',\
            '*_instanceIds.png', '*_labelIds.png', train_bbox_dst)
    construct_box('/datasets01/cityscapes/112817/gtFine/val',\
            '*_instanceIds.png', '*_labelIds.png', val_bbox_dst) 
